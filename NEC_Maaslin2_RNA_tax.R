...
SM_meta <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/taxonomy/Maaslin2/210923_maaslin_metadata_log_late.txt", header = TRUE,row.names = 1, na.strings = "NA")

#####Species
SM_DF <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/taxonomy/211108_RNA_metaphlan_matrix_late.txt", header = TRUE,row.names = 1)
...
fit_data = Maaslin2(
  ...
  min_prevalence = 0.1,
  output = "./Desktop/Projects/NEC/final_analysis/RNA/taxonomy/Maaslin2/species_late_cases_log", 
  fixed_effects = c("GA_birth","NEC_status","Days_pre_onset_log","ABX_recent","Recent_penicillin","Recent_amingoglycoside","Recent_glycopeptide",
                    "Recent_carbapenem","Recent_macrolide","Recent_1st_gen_cephalosporin","Recent_3rd_gen_cephalosporin","inf",
                    "Recent_4th_gen_cephalosporin","Abx_cumulative","ANTIM_cumulative","mat_ppbmi","mat_alcohol","mat_inpatient","mat_preeclampsia","intraventricular_hemorrhage",
                    "milk_current","milk_cumulative","formula_cumulative"),
