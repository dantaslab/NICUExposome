...
subject_2<-read.table('Desktop/Projects/NEC/final_analysis/taxonomy/PERMANOVA/Patients.txt', header = FALSE)
subject<-subject_2$V1
subject_data<-read.delim("./Desktop/Projects/NEC/final_analysis/taxonomy/PERMANOVA/subject/subject_NEC.txt", header = TRUE,check.names = FALSE, row.names=1)
