...
SM_DF <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/humann/211103_humann3_RNA_rel_abundance.txt", header = TRUE,row.names = 1,check.names=FALSE)
...
write.table(t(SM_DF2), "Desktop/Projects/NEC/final_analysis/RNA/humann/211108_humann_complete.txt", sep="\t")
...
fit_data = Maaslin2(
  ...
  fixed_effects = c("GA_birth","NEC_status","Days_pre_onset","ABX_recent","Recent_penicillin","Recent_amingoglycoside",
