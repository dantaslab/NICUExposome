...
SM_meta <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/humann/Maaslin/210923_maaslin_metadata_late.txt", header = TRUE,row.names = 1, na.strings = "NA")

#####Species
SM_DF <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/humann/211111_Humann_community_profiles_RA_late.txt", header = TRUE,row.names = 1)
...
fit_data = Maaslin2(
  ...
  min_prevalence = 0.1,
  output = "./Desktop/Projects/NEC/final_analysis/RNA/humann/Maaslin/late", 
  fixed_effects = c("NEC_status","GA_birth","Birthweight_log","Days_pre_onset_log","DOL_log","Recent_penicillin","Recent_amingoglycoside",
                    "Recent_lincosamide","Recent_carbapenem","Recent_1st_gen_cephalosporin",
                    "Recent_3rd_gen_cephalosporin","Recent_4th_gen_cephalosporin","Other_ANTIM_recent",
                    "milk_cumulative_log","Calcium_gluconate","Chlorathiazide","Cholecalciferol",
                    "Hydrocortisone","Indomethacin","Sodium_chloride",
                    "Dexamethasone","Dopamine","Fentanyl","Iron",
                    "Midazolam","Morphine","Multi_vitamin_with_iron","Phenobarbitol","Surfactant"),
