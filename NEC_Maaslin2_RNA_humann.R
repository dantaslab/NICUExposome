...
SM_meta <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/humann/Maaslin/211114_maaslin_metadata_early.txt", header = TRUE,row.names = 1, na.strings = "NA")

#####Species
SM_DF <- read.delim("./Desktop/Projects/NEC/final_analysis/RNA/humann/211111_Humann_community_profiles_reduced_relAbund_early.txt", header = TRUE,row.names = 1)
...
fit_data = Maaslin2(
  ...
  min_prevalence = 0.1,
  output = "./Desktop/Projects/NEC/final_analysis/RNA/humann/Maaslin/cases_vs_controls_early", 
  fixed_effects = c("GA_birth_log","NEC_status","Days_preonset_log","Abx_recent","Recent_carbapenem","Recent_3rd_gen_cephalosporin","Recent_4th_gen_cephalosporin",
                    "pda","inf","milk_current","milk_cumulative","mat_ppBMI","Abx_cumulative_log","route","gravida","mat_inpatient_meds",
                    "mat_preeclampsia","mat_steroids","ANTIM_cumulative","feeding_current","formula_cumulative","Recent_1st_gen_cephalosporin",
                    "Recent_amingoglycoside","Other_ANTIM_recent","Recent_glycopeptide","Recent_macrolide","Recent_penicillin"),
